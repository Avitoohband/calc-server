...
The token verification should be handled as middleware. For now token verification in our API is currently handled manually. We plan to shift this process to middleware for enhanced security and efficiency.
